...
INSTRUMENT_CONFIG_PATH = "data.equity.csvconfig"
CONFIG_FILE_NAME = "instrumentconfig.csv"

class csvEquityInstrumentData(equityInstrumentData):
    def __init__(
        self,
        datapath=arg_not_supplied,
        log=get_logger("csvEquityInstrumentData")
    ):
...
def get_instrument_with_meta_data_object(
    ...
    instrument_with_meta_data = equityInstrumentWithMetaData(instrument, meta_data)
