...
@dataclass
class equityInstrumentWithMetaData:
    ...
    def from_dict(futuresInstrumentWithMetaData, input_dict):
        ...
        instrument = equityInstrument(instrument_code)
    ...
    def create_empty(futuresInstrumentWithMetaData):
        instrument = equityInstrument(EMPTY_INSTRUMENT)
        meta_data = instrumentMetaData()
...
class listOfEquityInstrumentWithMetaData(list):
    def as_df(self):
        instrument_codes = [
...
class instrumentCosts(object):
    ...
    def from_meta_data_and_spread_cost(
        ...
        raise NotImplementedError("Costs need to implemented later")
